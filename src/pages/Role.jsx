    ...
    <Container className='sign__info'>
      ...
      <div>
        ...
        <div className='alternative__btn d-flex align-items-center gap-3'>
            <Button className='alternative d-flex align-items-center gap-2' value={'customer'} onClick={(e)=>navigate(`/get-started/register?role=${e.target.value}`)}>
                Customer
              </Button>
              <Button className='alternative d-flex align-items-center gap-2' value={'seller'} onClick={(e)=>navigate(`/get-started/register?role=${e.target.value}`)}>
                Seller
              </Button>
            </div>
      </div>
